...
assert.match(outputEditor, /grid min-w-0 items-start gap-3/);
assert.match(review, /data-testid="batch-output-editor-scroll-area"/);
assert.match(review, /min-h-0 flex-1 overflow-y-auto pr-1/);
