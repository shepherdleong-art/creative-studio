import { defaultTextStyle, normalizeTextStyle } from './cover-domain.ts';
import { OUTPUT_PRESETS, type CoverFraming, type CoverPresetV2, type OutputPresetId, type TextStyle } from './cover-types.ts';
